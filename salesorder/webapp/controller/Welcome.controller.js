sap.ui.define([
    ...
    function (BaseController, cart, JSONModel, Filter, formatter) {
        ...
        return BaseController.extend("zcb.sd.salesorder.controller.Welcome", {
            ...
            onInit: function () {
                var oViewModel = new JSONModel({
                    welcomeCarouselShipping: 'zcb/sd/salesorder/img/ShopCarouselShipping.jpg',
                    welcomeCarouselInviteFriend: 'zcb/sd/salesorder/img/ShopCarouselInviteFriend.jpg',
                    welcomeCarouselTablet: 'zcb/sd/salesorder/img/ShopCarouselTablet.jpg',
                    welcomeCarouselCreditCard: 'zcb/sd/salesorder/img/ShopCarouselCreditCard.jpg',
                    Promoted: [],
                    Viewed: [],
                    Favorite: [],
                    Currency: "EUR"
