		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 판매계획 차트",
									"targetURL": "#zcbsdchart01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcbsdchart01-display": {
								"semanticObject": "zcbsdchart01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcb.sd.chart01",
									"url": sap.ui.require.toUrl("zcb/sd/chart01")
								}
							}
						}
					}
