		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SD] 판매계획 월별 그래프",
									"targetURL": "#zcbsdsalesplanchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcbsdsalesplanchart-display": {
								"semanticObject": "zcbsdsalesplanchart",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcb.sd.salesplan.chart",
									"url": sap.ui.require.toUrl("zcb/sd/salesplan/chart")
								}
							}
						}
					}
